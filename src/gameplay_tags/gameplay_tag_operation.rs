...
//     mut manager: ResMut<GameplayTagManager>,
...
//             let ref_counts = &mut manager.get_ref_counts_mut(container_index);
...
//                     if manager.check_has_active_descendants(tag_bit_index, &manager.get_ref_counts(container_index)) {
//                         continue;
//                     }
//
//                     if let Some(inherited_bits) = manager.get_inherited_bits(tag) {
